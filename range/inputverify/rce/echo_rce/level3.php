<?php
/**
 * HeaSec天积安全团队 - 回显型命令注入靶场 - 第三关（空白字符过滤绕过）
 * 版本: v1.0.0
 * 创建日期: 2026-04-22
    ...
    <div class="tech-card">
        ...
        <div class="tech-card-body">
            <div class="alert-info">
                ...
                <span>当前系统的网络诊断工具支持输入IP地址进行连通性检测，系统会调用ping命令对目标地址进行探测并返回结果。注意：系统已升级安全检测机制</span>
            </div>

            <div class="alert-warning">
                <div>
                    <strong>任务目标：</strong>
                    绕过安全过滤执行系统命令 <code>netstat -ano</code>（Windows）或 <code>uname -a</code>（Linux）。提示：没有空格的话，你怎么把命令和它的参数分开呢？
                </div>
            </div>
