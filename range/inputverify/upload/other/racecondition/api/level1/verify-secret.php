<?php
/**
 * HeaSec天积安全团队 - 条件竞争上传靶场 - 第一关通关验证接口
 * 版本: v1.0.0
...
// 获取正确的通关密码
$correctSecret = isset($_SESSION['racecondition_level1_secret']) ? $_SESSION['racecondition_level1_secret'] : '';
...
if ($userSecret === $correctSecret) {
    // 设置通关状态
    $_SESSION['racecondition_level1_passed'] = true;
