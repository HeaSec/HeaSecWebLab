    ...
    <div class="tech-card">
        ...
        <div class="tech-card-body">
            ...
            <div class="alert-warning">
                <div>
                    <strong>任务目标：</strong>
                    <small>利用XXE漏洞读取config目录下的secret.php文件，获取通关密码。提示：目标文件是PHP文件，直接读取可能导致XML解析出错</small>
                </div>
            </div>
