<?php
/**
 * HeaSec天积安全团队 - XXE绕过靶场 - 第三关XML处理接口
 * 版本: v1.0.0
 * 创建日期: 2026-04-10
...
// 安全过滤：正则精确匹配所有危险关键字
if (preg_match('/\bDOCTYPE\b/i', $xmlData) ||
    preg_match('/\bENTITY\b/i', $xmlData) ||
    preg_match('/\bSYSTEM\b/i', $xmlData) ||
    preg_match('/\bPUBLIC\b/i', $xmlData)) {
    sendJsonResponse(false, '检测到危险关键字，禁止导入');
}
