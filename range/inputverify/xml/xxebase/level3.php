...
// 确保当前关卡的secret.php存在（第三关使用精简版，单行无换行符）
    ...
    <div class="tech-card">
        ...
        <div class="tech-card-body">
            ...
            <div class="alert-info">
                ...
                <span>当前系统支持通过XML文件批量导入商品数据，注意字符长度有限，超过的数据会被截断。</span>
            </div>
            ...
            <div class="alert-warning">
                <div>
                    <strong>任务目标：</strong>
                    <small>利用XXE漏洞读取config/level3目录下的secret.ini文件。</small>
                    <?php if ($isWindows): ?>
