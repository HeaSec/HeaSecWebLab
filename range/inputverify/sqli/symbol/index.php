    ...
    <div class="tech-card">
        ...
        <div class="tech-card-body">
            ...
            <div class="alert-info">
                ...
                <span>天积分司运维管理平台 — 服务器资产查询功能。请输入服务器ID查询服务器信息，系统将返回查询结果</span>
            </div>
            ...
            <div class="alert-warning">
                <div>
                    <strong>任务目标：</strong>
                    <small>利用SQL注入漏洞获取通关密码。提示：系统对输入进行了特殊字符过滤，通关密码存储在 heasec_symbol_servers 表中</small>
                </div>
            </div>
                ...
                <form id="queryForm" class="query-form">
                    <div class="form-group">
                        <label for="serverId" class="form-label">
                            <i class="fa fa-server"></i> 服务器ID
                        </label>
                        <input type="text" id="serverId" name="id" class="tech-input" placeholder="请输入服务器ID" autocomplete="off">
                    </div>
