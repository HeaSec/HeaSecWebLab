...
// 设置响应头
header('X-HeavenlySecret: HeaSec 文件相关XSS通关API v1.0.0');
...
try {
    ...
    if ($level === 1 || $level === 2) {
        HeaSec_UpdateLearningStatus('filexss', '学习中');
    } elseif ($level === 3) {
        HeaSec_UpdateLearningStatus('filexss', '已掌握');
    }
