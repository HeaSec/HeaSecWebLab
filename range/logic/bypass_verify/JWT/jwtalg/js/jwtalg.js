...
(function () {
     ...
     */
    window.initJwtAlg = function (level, basePath) {
            ...
            fetch('api/login.php', {
                ...
                .then(function (data) {
                    if (data.success) {
                        ...
                        localStorage.setItem('jwtalg_token_' + currentLevel, data.token);
    ...
    function bindLogoutButton() {
        ...
        logoutBtn.addEventListener('click', function () {
            // 清除Token
            currentToken = null;
            localStorage.removeItem('jwtalg_token_' + currentLevel);
    ...
    function checkExistingToken() {
        var savedToken = localStorage.getItem('jwtalg_token_' + currentLevel);
        if (savedToken) {
                    ...
                    onConfirm: function (modal) {
                        ...
                        fetch('api/reset.php', {
                            ...
                            .then(function (data) {
                                ...
                                if (data.success) {
                                    // 清除所有Token
                                    localStorage.removeItem('jwtalg_token_1');
                                    localStorage.removeItem('jwtalg_token_2');
                                    localStorage.removeItem('jwtalg_token_3');
