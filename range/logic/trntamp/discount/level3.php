...
if ($sessionUserId) {
    ...
    if ($user) {
        ...
        $userData = [
            ...
            'firstPurchase' => $user['first_purchase']
        ];
        $products = getProducts($currentLevel, $pdo);
        $paidCount = getPaidYuanbaoCount($user['id'], $currentLevel, $pdo);

        // 初始化通关密码（首次登录时生成）
        initUserPasscode($user['id'], $currentLevel, $pdo);

        // 检查是否满足通关条件，满足则展示通关密码
        if (checkLevel3PassCondition($user['id'], $currentLevel, $pdo)) {
        ...
        <div class="tech-card-body">
            ...
            <div id="userInfoArea" style="display: none;">
                <div class="user-info">
                    ...
                    <div class="info-row">
                        <span class="info-label"><i class="fa fa-diamond"></i> 已购买：</span>
                        <span class="info-value yuanbao-count" id="displayPaidCount">0</span>
                        <span class="yuanbao-hint">/ 3</span>
                    </div>
                </div>
                ...
                <div class="promo-banner">
                    ...
                    <span>首购优惠10元/个，每位用户限享1次！</span>
                </div>

                <div id="passcodeHint" class="alert-info" style="display: none;">
                ...
                <div class="cart-section">
                    ...
                    <div id="cartSummary" class="cart-summary" style="display: none;">
                        <div class="cart-summary-row" style="margin-left:auto;">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        displayUserInfoFromServer({
            ...
            firstPurchase: <?php echo $userData['firstPurchase'] ? 'true' : 'false'; ?>,
            paidCount: <?php echo $paidCount; ?>,
