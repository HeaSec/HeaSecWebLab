...
if ($sessionUserId) {
    ...
    if ($user) {
        ...
        if (checkLevel2PassCondition($user['id'], $currentLevel, $pdo)) {
        ...
        <div class="tech-card-body">
            ...
            <div id="userInfoArea" style="display: none;">
                <div class="user-info">
                    ...
                    <div class="info-row">
                        <span class="info-label"><i class="fa fa-star"></i> 积分：</span>
                        <span class="info-value points" id="displayPoints">0</span>
                        <small style="color: #8892a0; margin-left: 5px;">（100积分=1元）</small>
                    </div>
                </div>
                ...
                <div class="cart-section">
                    ...
                    <div id="cartSummary" class="cart-summary" style="display: none;">
                        <div class="cart-summary-row">
                            ...
                            <select id="globalPaymentType" style="display: none;">
                                <option value="balance">余额支付</option>
                                <option value="points" id="pointsOptionNative">积分支付</option>
                            </select>
                            <div class="custom-select-wrapper">
                                <div class="custom-select" id="customPaymentSelect">
                                    <div class="custom-select-trigger" id="customPaymentTrigger">
                                        <span class="custom-select-text">余额支付</span>
                                        <i class="fa fa-chevron-down"></i>
                                    </div>
                                    <div class="custom-select-options" id="customPaymentOptions">
                                        <div class="custom-option selected" data-value="balance">余额支付</div>
                                        <div class="custom-option" data-value="points" id="customOptionPoints">积分支付</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="cart-summary-row">
                            <span class="label">需支付余额：</span>
                            <span class="value balance" id="totalBalance">¥0.00</span>
                        </div>
                        <div class="cart-summary-row">
                            <span class="label">需支付积分：</span>
                            <span class="value points" id="totalPoints">0积分</span>
                        </div>
