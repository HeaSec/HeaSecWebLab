<?php
/**
 * HeaSec天积安全团队 - 三方支付漏洞靶场 - 第一关天积宝支付页面
 * 版本: v1.0.0
 * 创建日期: 2026-03-19
        ...
        <div class="pay-body">
            <div class="order-info">
                ...
                <div class="order-row">
                    ...
                    <span class="order-amount">¥<span id="displayAmount"><?php echo number_format($amount, 2); ?></span></span>
                </div>
            </div>
