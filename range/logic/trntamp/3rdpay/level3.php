...
if ($sessionUserId) {
    ...
    if ($user) {
        ...
        // 获取用户拥有的天积元宝数量
        $yuanbaoCount = getUserYuanbaoCount($user['id'], $currentLevel, $pdo);
            ...
            <div id="userInfoArea" <?php echo !$isLoggedIn ? 'style="display: none;"' : ''; ?>>
                <div class="user-info">
                    <div class="info-row">
                        ...
                        <span class="info-value"
                            id="displayUsername"><?php echo $isLoggedIn ? htmlspecialchars($userData['username']) : ''; ?></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label"><i class="fa fa-diamond"></i> 天积元宝：</span>
                        <span class="info-value yuanbao-count" id="displayYuanbao"><?php echo $yuanbaoCount; ?></span>
                        <span class="yuanbao-hint">/ <?php echo $requiredYuanbao; ?></span>
                    </div>
                </div>
                            ...
                            <div class="product-card">
                                ...
                                <div class="product-action">
                                    <div class="quantity-input">
                                        ...
                                        <input type="input" id="quantity" value="1">
                ...
                <div id="passcodeArea" class="passcode-section" <?php echo !$passcode ? 'style="display: none;"' : ''; ?>>
                    <div class="passcode-display">
                        ...
                        <span class="passcode-value"
                            id="displayPasscode"><?php echo $passcode ? htmlspecialchars($passcode) : ''; ?></span>
                    </div>
                </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        init3rdpay(<?php echo $currentLevel; ?>, '<?php echo $commonBasePath; ?>', '<?php echo $payPage; ?>', <?php echo $requiredYuanbao; ?>);
