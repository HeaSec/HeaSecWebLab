...
// 当前关卡配置
$currentLevel = 3;
$levelTitle = '第三关：天下武功，唯……';
$signinHint = '每天只能签到一次，获得100元红包';
$nextPage = '';
$nextBtnText = '完成';
...
// 确保用户存在
function ensureUserExistsLevel3($level, $pdo) {
...
ensureUserExistsLevel3($currentLevel, $pdo);
