...
require_once $privescCommonBasePath . 'includes/HeaSec_Database.php';
require_once $privescCommonBasePath . 'components/vuln-card/includes/HeaSec_VulnManager.php';
