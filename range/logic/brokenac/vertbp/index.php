...
// 如果已登录，重定向到管理页面
if ($isLoggedIn) {
    $userRole = isset($_SESSION['vertbp_level1_user']['role']) ? $_SESSION['vertbp_level1_user']['role'] : 'user';
    header('Location: admin.php?role=' . urlencode($userRole));
    exit;
}
?>
