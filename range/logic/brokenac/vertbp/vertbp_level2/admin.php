...
$currentUser = isset($_SESSION['vertbp_level2_user']) ? $_SESSION['vertbp_level2_user'] : null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'logout') {
    unset($_SESSION['vertbp_level2_logged_in']);
    unset($_SESSION['vertbp_level2_user']);
    // 清除Cookie
    setcookie('vertbp_level2_is_admin', '', time() - 3600, '/');
    header('Location: index.php');
    exit;
}

// 使用Cookie中的状态决定当前展示的功能区域
$isAdmin = isset($_COOKIE['vertbp_level2_is_admin']) && $_COOKIE['vertbp_level2_is_admin'] === '1';
...
<div class="tech-container">
    ...
    <div class="tech-card">
        <div class="tech-card-header">
            <h3>
                <i class="fa fa-wifi"></i> HeaSec-TJRouter-X1000 - 第二关
            </h3>
