...
// 检查登录状态
$isLoggedIn = isset($_SESSION['idref_level1_logged_in']) && $_SESSION['idref_level1_logged_in'] === true;
$currentUser = isset($_SESSION['idref_level1_user']) ? $_SESSION['idref_level1_user'] : null;

// 处理退出登录请求
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'logout') {
    unset($_SESSION['idref_level1_logged_in']);
    unset($_SESSION['idref_level1_user']);
    $isLoggedIn = false;
    $currentUser = null;
}
        ...
        <div class="tech-card-body">
            ...
            <div class="alert alert-warning">
                ...
                <span class="alert-hint">
                    <small>管理员的个人信息中包含通关密码，想办法获取它</small>
                </span>
            </div>
