    ...
    <div class="tech-card">
        ...
        <div class="tech-card-body">
            ...
            <div class="alert-info">
                ...
                <span>当前系统提供公开文件下载服务，过滤了危险字符</span>
            </div>
            ...
            <div class="alert-warning">
                <div>
                    <strong>任务目标：</strong>
                    <small>下载本靶场目录的config下level2目录下的secret.php文件，获取通关密码。注意每关的文件下载路径不同（藏得更深才安全）</small>
                </div>
            </div>
